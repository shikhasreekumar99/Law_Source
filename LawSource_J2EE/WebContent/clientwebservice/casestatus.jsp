...
<%@include file="../databaseconnection.jsp" %>
    ...
    try
    {
    	...
    	String s="select * from tbl_case where tbl_clint_id='"+id+"' ";
    	System.out.println(s);
    	
    	String casestatus="",paymentstatus="";
    	String casetitle="",fee="";
    	String casetype="",lawyer="",desc="",no="",cid="";
    	...
    	while(rs.next())
    	{
    		...
    		lawyer=rs.getString("tbl_lawyer_id");
