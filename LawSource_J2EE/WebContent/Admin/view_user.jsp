...
{
	$.getJSON("viewclientaction.jsp",function(json)
	{
		var i=0;
		while(i<json.length)
		{
			$('#tablebody').append('<tr><td>'+json[i].name+'</td><td>'+json[i].age+'</td><td>'+json[i].gender+'</td><td>'+json[i].address+'</td><td>'+json[i].district+'</td></tr>');
			i++;
		}	
	});
...
<div class="main">
   ...
   <div class="large_outer">  
		...
		<tbody style="overflow-y:scroll; height:400px;" id="tablebody" >
