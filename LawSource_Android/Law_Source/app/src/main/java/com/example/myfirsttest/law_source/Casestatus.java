...
public class Casestatus extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        new AsyncHttpTask().execute("http://"+sp.getString("ipaddrress","")+"/LawSource/clientwebservice/casestatus.jsp?id="+userid);
    ...
    public class AsyncHttpTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute (String s){
            ...
            pdialog.dismiss();
            Log.d("'",resp);
            Caseadaptor bp=new Caseadaptor(getContext(),ctitle,ctype,nam,mob,mail,desc,caseid,fee);
