 ...
 */
public class Lawyers extends Fragment {
    ViewFlipper flipper;
    private View thisFragment;
    View myView;
    Animation fade_in, fade_out;
    ViewFlipper viewFlipper;
    String web_response,resp="",userid="",n1,n2,n3,n4,n5,n6,n7;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.lawyersearch, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        new AsyncHttpTask().execute("http://"+sp.getString("ipaddrress","")+"/LawSource/clientwebservice/getlawyers.jsp");
        ...
        protected void onPostExecute (String s){
            ...
            textView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    new AsyncHttpTask1().execute("http://"+sp.getString("ipaddrress","")+"/LawSource/clientwebservice/lawyer.jsp?district="+selState);
