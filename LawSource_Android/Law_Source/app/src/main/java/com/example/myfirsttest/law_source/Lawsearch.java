 ...
 */
public class Lawsearch extends Fragment {
    ViewFlipper flipper;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.lawsearch, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        new AsyncHttpTask().execute("http://"+sp.getString("ipaddrress","")+"/LawSource/clientwebservice/getipc.jsp");
        ...
        protected void onPostExecute (String s){
            ...
            textView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                    ...
                    new AsyncHttpTask1().execute("http://"+sp.getString("ipaddrress","")+"/LawSource/clientwebservice/searchipc.jsp?district="+selState);
    ...
    public class AsyncHttpTask1 extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute (String s){
            ...
            pdialog.dismiss();
            Log.d("'",resp);
            Transadaptor bp=new Transadaptor(getContext(),name,address,expansion);
    ...
    private void parseResult1(String response_string) {
        ...
        try
        {
            ...
            while(i<ja.length()) {
                jo = ja.getJSONObject(i);
                n2 = jo.getString("section");
                n3 = jo.getString("description");
                n4=jo.getString("expanssion");
