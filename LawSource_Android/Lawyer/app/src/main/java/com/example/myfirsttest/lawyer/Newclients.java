 ...
 */
public class Newclients extends Fragment {
    ViewFlipper flipper;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.newclients, container, false);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        new AsyncHttpTask().execute("http://"+sp.getString("ipaddrress","")+"/LawSource/lawyerwebservice/newclients.jsp?id="+userid);
    ...
    public class AsyncHttpTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute (String s){
            ...
            pdialog.dismiss();
            Log.d("'",resp);
            Clientadaptor bp=new Clientadaptor(getContext(),ctitle,ctype,nam,mob,mail,desc,caseid);
