...
public class Clients extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        new AsyncHttpTask().execute("http://"+sp.getString("ipaddrress","")+"/LawSource/lawyerwebservice/clients.jsp?id="+userid);
    ...
    public class AsyncHttpTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute (String s){
            ...
            pdialog.dismiss();
            Log.d("'",resp);
            Transadaptor bp=new Transadaptor(getContext(),ctitle,ctype,nam,mob,mail);
