...
if(items5.get(position).equals("paid"))
{
...
submit.setOnClickListener(new View.OnClickListener() {
	...
	public void onClick(View view) {
		...
		dialog.setContentView(R.layout.dialogcase);
		dialog.setTitle("Case Status Update");
		dialog.show();
		...
		subb.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View view) {
				...
				new AsyncHttpTask().execute("http://"+sp.getString("ipaddrress","")+"/LawSource/lawyerwebservice/statusupdate.jsp?caseid="+items7.get(position)+"&status="+gender+"&comment="+comment);
