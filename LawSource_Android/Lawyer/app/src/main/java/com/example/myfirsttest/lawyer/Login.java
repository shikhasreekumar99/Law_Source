...
public class Login extends AppCompatActivity {
    ...
    public void login() {
        ...
        if (isNetworkAvailable()) {
            ...
            new AsyncHttpTask().execute("http://"+sp.getString("ipaddrress","")+"/LawSource/lawyerwebservice/login.jsp?username="+email+"&password="+password);
            Log.d(TAG,"http://"+sp.getString("ipaddrress","")+"/LawSource/lawyerwebservice/login.jsp?username="+email+"&password="+password);
        } else {
