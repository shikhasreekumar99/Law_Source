 ...
 */
public class Paystatus extends Fragment {
    ViewFlipper flipper;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.paystatus, container, false);
    ...
    public class AsyncHttpTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute (String s){
            ...
            pdialog.dismiss();
            Log.d("'",resp);
            Payadaptor bp=new Payadaptor(getContext(),ctitle,ctype,nam,mob,mail,desc,caseid);
