...
public class Clientadaptor extends BaseAdapter
{
	...
	public Clientadaptor(Context ipcsection, ArrayList<String> date,
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		// TODO Auto-generated method stub
		convertView=LayoutInflater.from(con).inflate(R.layout.newclientlist, null);
...
submit.setOnClickListener(new View.OnClickListener() {
	...
	public void onClick(View view) {
		...
		dialog.setContentView(R.layout.casedialog);
		dialog.setTitle("Case Approve/Reject");
		dialog.show();


		subb=(Button) dialog.findViewById(R.id.subs) ;
		nameText=(EditText) dialog.findViewById(R.id.input_name) ;
		...
		subb.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View view) {
				comment1 = nameText.getText().toString();
				...
				try {
					comment = URLEncoder.encode(comment1, "UTF-8");
				...
				new AsyncHttpTask().execute("http://"+sp.getString("ipaddrress","")+"/LawSource/lawyerwebservice/caseapprove.jsp?caseid="+items7.get(position)+"&status="+gender+"&comment="+comment);
	...
	public class AsyncHttpTask extends AsyncTask<String, Void, String> {
		...
		protected void onPreExecute () {
			...
			pdialog.setMessage("Proceesing Update");
		...
		protected void onPostExecute (String s){
			...
			if(resp.equals("success"))
			{
				...
				dialog.dismiss();
                Newclients pro_details = new Newclients();
