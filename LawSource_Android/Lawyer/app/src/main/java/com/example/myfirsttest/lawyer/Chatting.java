    ...
    public void onActivityCreated(Bundle savedInstanceState) {
       ...
       // showNotification();
        ...
        toid=sp.getString("TON_ID","");
                new AsyncHttpTask1().execute("http://"+sp.getString("ipaddrress","")+"/LawSource/lawyerwebservice/viewchat.jsp?userid="+userid+"&lawyerid="+toid);
...
sent.setOnClickListener(new View.OnClickListener() {
    ...
    public void onClick(View view) {
        ...
        if (message.equals("")) {
            ...
            new AsyncHttpTask().execute("http://"+sp.getString("ipaddrress","")+"/LawSource/lawyerwebservice/sendchat.jsp?userid="+userid+"&lawyerid="+toid+"&msg="+message1);
        }
    }
});
