...
String p1,p2,p3,p4,p5,p6,p7,p8,p9,p10;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
       /* edit=(Button) getView().findViewById(R.id.btn_signup);
        ...
        Log.e("","http://"+sp.getString("ipaddrress","")+"/LawSource/lawyerwebservice/profile.jsp?id="+userid);
            new AsyncHttpTask().execute("http://"+sp.getString("ipaddrress","")+"/LawSource/lawyerwebservice/profile.jsp?id="+userid);
...
//                    s4 = URLEncoder.encode(p4, "UTF-8");
                ...
                userid=sp.getString("user_id","");
                    ...
                    new AsyncHttpTask1().execute("http://"+sp.getString("ipaddrress","")+"/LawSource/lawyerwebservice/editprofile.jsp?id="+userid+"&name="+s1+"&age="+s2+"&gender="+s9+"&mobile="+s5+"&username="+s6+"&password="+s3+"&address="+s7+"&district="+s8);
