...
public class Signup extends AppCompatActivity {
    ...
    EditText emailText,input_mobile,input_username,input_address,inputdistrict,ipfees;
    Button signupButton;
    TextView loginLink;
    ...
    String name,age1,mob,user,gender,type;
    ...
    String email2,address2,district2,fees,fees2;
    String password2;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ipfees=(EditText) findViewById(R.id.fees);
        ...
        radioButton1 = (RadioButton) findViewById(R.id.radioMale1);
    ...
    signupButton.setEnabled(false);*/
        ...
        try {
            ...
            fees = URLEncoder.encode(fees2, "UTF-8");
        ...
        if (isNetworkAvailable()) {
            ...
            new AsyncHttpTask().execute("http://"+sp.getString("ipaddrress","")+"/LawSource/lawyerwebservice/register.jsp?name="+name+"&age="+age1+"&gender="+gender+"&email="+email+"&mobile="+mob+"&username="+user+"&password="+password1+"&address="+address+"&district="+district+"&fees="+fees+"&type="+type);
    ...
    public class AsyncHttpTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute (String s){
            ...
            if(resp.equals("success"))
            {
                ...
                alertDialog3.setIcon(R.drawable.advocate);
            ...
            else if(resp.equals("email"))
            {
                ...
                // Setting Icon to Dialog
                alertDialog1.setIcon(R.drawable.advocate);
