...
Button search;
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        userid=sp.getString("user_id","");
                new AsyncHttpTask1().execute("http://"+sp.getString("ipaddrress","")+"/LawSource/lawyerwebservice/myclients.jsp?id="+userid);
    ...
    public class AsyncHttpTask1 extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute (String s){
            ...
            pdialog.dismiss();
            Log.d("'",resp);
            Chatadaptor bp=new Chatadaptor(getContext(),address,name);
